...
std::cout << "mx  " << isMX  <<std::endl;
std::cout << "x  " << isX  <<std::endl;
std::cout << "none  " << isNone  <<std::endl;
std::cout << "other  " << isOther  <<std::endl;
...
//		}
	...
	else if(m_servos->type == DynamixelBase::X_SERVOS)  //ignore
	{
