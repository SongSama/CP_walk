...
//	sagittal_x_pub = m_nhs.advertise<std_msgs::Float64>("/zjlabers_sim/sagittal_x", 1);
//	sagittal_vx_pub = m_nhs.advertise<std_msgs::Float64>("/zjlabers_sim/sagittal_vx", 1);
//	lateral_y_pub = m_nhs.advertise<std_msgs::Float64>("/zjlabers_sim/sagittal_y", 1);
//	lateral_vy_pub = m_nhs.advertise<std_msgs::Float64>("/zjlabers_sim/sagittal_vy", 1);
