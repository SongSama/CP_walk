...
//		ros::Publisher sagittal_x_pub, sagittal_vx_pub, lateral_y_pub, lateral_vy_pub;
//		std_msgs::Float64 sagittal_x_data, sagittal_vx_data, lateral_y_data, lateral_vy_data;
